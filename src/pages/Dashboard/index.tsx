...
import formatValueToNegative from '../../utils/formatValueToNegative';
...
const Dashboard: React.FC = () => {
  const [transactions, setTransactions] = useState<Transaction[]>(() => {
    ...
    if (storagedTransactions) return JSON.parse(storagedTransactions);
        ...
        (transaction: Transaction) => {
          const formattedValue =
            transaction.type === 'outcome'
              ? formatValueToNegative(transaction.value)
